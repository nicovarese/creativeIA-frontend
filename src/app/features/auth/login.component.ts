  ...
  template: `
    <div class="wrap">
      <div class="panel">
        ...
        <p class="subtitle">Entrá a tu espacio de proyectos y biblioteca.</p>
        <div class="field">
        ...
        <div class="field">
          ...
          <input class="input" [(ngModel)]="password" type="password" autocomplete="current-password">
        </div>
        <div class="row">
          <button class="btn primary" (click)="submit()" [disabled]="loading">Entrar</button>
